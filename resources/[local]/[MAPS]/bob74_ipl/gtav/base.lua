Citizen.CreateThread(function()
	...
	-- Del Perro Pier - Ferris Wheel Fix: -1654.6622314453, -1121.9139404297, 13.027465820313
	RequestIpl("ferris_finale_anim")
	RequestIpl("ferris_finale_anim_lod")

	-- FIB Building Fountain Texture Fix: 184.48793029785, -678.62164306641, 43.14094543457
	RequestIpl("dt1_05_hc_remove")

	-- The Mile High Club Skyscraper Construction Site @ Pillbox Hill
	-- Enable the missing elevator lifts: -156.20492553711, -945.26287841797, 269.13494873047
