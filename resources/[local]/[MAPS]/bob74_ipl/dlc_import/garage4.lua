...
ImportCEOGarage4 = {
    ...
    LoadDefault = function()
        ...
        ImportCEOGarage4.Style.Set(ImportCEOGarage4.Part.Garage2, ImportCEOGarage4.Style.marble, false)
        ImportCEOGarage4.Numbering.Set(ImportCEOGarage4.Part.Garage2, ImportCEOGarage4.Numbering.Level1.style2, false)
        ImportCEOGarage4.Lighting.Set(ImportCEOGarage4.Part.Garage2, ImportCEOGarage4.Lighting.style6, false)
        
        ImportCEOGarage4.Part.Load(ImportCEOGarage4.Part.ModShop)
        ImportCEOGarage4.ModShop.Floor.Set(ImportCEOGarage4.ModShop.Floor.marbleBW, false)
    end
}
