...
ImportCEOGarage1 = {
    ...
    LoadDefault = function()
        ...
        ImportCEOGarage1.Style.Set(ImportCEOGarage1.Part.Garage1, ImportCEOGarage1.Style.plain, false)
        ImportCEOGarage1.Numbering.Set(ImportCEOGarage1.Part.Garage1, ImportCEOGarage1.Numbering.Level1.style4, false)
        ImportCEOGarage1.Lighting.Set(ImportCEOGarage1.Part.Garage1, ImportCEOGarage1.Lighting.style2, false)
        
        ImportCEOGarage1.Part.Load(ImportCEOGarage1.Part.ModShop)
        ImportCEOGarage1.ModShop.Floor.Set(ImportCEOGarage1.ModShop.Floor.grid, false)
    end
}
