...
ImportCEOGarage2 = {
    ...
    LoadDefault = function()
        ...
        ImportCEOGarage2.Numbering.Set(ImportCEOGarage2.Part.Garage1, ImportCEOGarage2.Numbering.Level1.style3, false)
        ...
        ImportCEOGarage2.ModShop.Floor.Set(ImportCEOGarage2.ModShop.Floor.money, false)
    end
}
