...
DoomsdayFacility = {
    ...
    LoadDefault = function()
        ...
        DoomsdayFacility.Walls.SetColor(DoomsdayFacility.Colors.supremacy)
        DoomsdayFacility.Decals.Set(DoomsdayFacility.Decals.style08)
        DoomsdayFacility.Lounge.Set(DoomsdayFacility.Lounge.premier, DoomsdayFacility.Colors.supremacy)
        DoomsdayFacility.Sleeping.Set(DoomsdayFacility.Sleeping.premier, DoomsdayFacility.Colors.supremacy)
        DoomsdayFacility.Security.Set(DoomsdayFacility.Security.on, DoomsdayFacility.Colors.supremacy)
        DoomsdayFacility.Cannon.Set(DoomsdayFacility.Cannon.on, DoomsdayFacility.Colors.supremacy)
        ...
        DoomsdayFacility.Details.Trophies.SetColor(DoomsdayFacility.Colors.supremacy)
