...
SmugglerHangar = {
    ...
    LoadDefault = function()
        ...
        SmugglerHangar.Cranes.Set(SmugglerHangar.Cranes.on, SmugglerHangar.Colors.colorSet3)
        ...
        SmugglerHangar.ModArea.Set(SmugglerHangar.ModArea.on, SmugglerHangar.Colors.colorSet3)

        SmugglerHangar.Office.Set(SmugglerHangar.Office.modern)

        SmugglerHangar.Bedroom.Style.Set(SmugglerHangar.Bedroom.Style.modern, SmugglerHangar.Colors.colorSet3)
