...
DisableInteriorProp(int_arcade1, "entity_set_mural_neon_option_07")--signboard
DisableInteriorProp(int_arcade1, "entity_set_mural_neon_option_08")--signboard
...
DisableInteriorProp(int_plan1, "set_plan_casino") --casino on the table
...
DisableInteriorProp(int_plan1, "set_plan_drone_parts")
