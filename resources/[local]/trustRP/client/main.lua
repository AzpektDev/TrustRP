...
CreateThread(function()
	while true do
        ...
        SetRichPresence('ID: ' .. id .. ' | '.. name .. ' | ' .. tostring(exports['esx_scoreboard']:BierFrakcje('players')) .. '/64')
		AddTextEntryByHash('FE_THDR_GTAO', 'FoxRP')
		SetDiscordRichPresenceAction(0, "DOŁĄCZ DO NAS!", "discord.gg/foxrp")
		Citizen.Wait(60000)
	end
end)
