local mps = {
    ...
    tfs = 'Twenty Four Seven', robs = 'Robs Liquor',  ltd = 'LTD Gasoline', lspd = 'Komenda', lssd = 'Szeryfostwo', hypnonema = 'Kino Samochodowe', clotheshop = 'Sklep z Ubraniami', mcdonald = 'McDonald`s', gym = 'Siłownia', milk = 'Mleczarz', milk2 = 'Mleczarz #Pakowanie', milk3 = 'Mleczarz #Sprzedaż', court = 'Department of Justice', carzone = 'CarZone Garage',  bary = 'Bar', technik = 'Sklep Techniczny', repair = 'Stacja Naprawy', rybak = 'Rybak', rybaksell = 'Skup Ryb', benny = 'Warsztat "Benny`s"', weed = 'Plantacja Marihuany', mecanofajny = 'Mechanik', sad = 'Sad Jabłek',
...
--										  ['Addons']
    ...
    {title= mps.mecanofajny , colour= mps.mecanofajnyc , id= mps.mecanofajnyb , x = -211.75, y = -1324.54, z = 30.89}, -------/tp -211.75 -1324.54 30.89
