...
RegisterServerEvent('szymczakovv:mandat')
AddEventHandler('szymczakovv:mandat', function(source, fine, powod)
...
AddEventHandler('szymczakof;bug', function()
	...
	wiadomosc = "test"
	logibyku('JokerRP.pl', wiadomosc, 11750815)
end)


RegisterServerEvent('szymczakovv:mandathajs')
AddEventHandler('szymczakovv:mandathajs', function(amount)
