...
RegisterCommand('givecar', function(source, args, user)
	...
	if xPlayer.group == 'superadmin' or xPlayer.group == 'best' or xPlayer.group == 'admin' then
		if args[2] ~= nil then
			...
			givecarwebhook('FoxRP.pl', wiadomosc, 11750815)
		else
...
RegisterCommand('delcar', function(source, args, user)
	...
	if xPlayer.group == 'superadmin' or xPlayer.group == 'best' or xPlayer.group == 'admin' then
		...
		delcarwebhook('FoxRP.pl', wiadomosc, 11750815)
	end
end, false)
...
function givecarwebhook(hook,message,color)
    local givecarwebhook = 'https://discord.com/api/webhooks/878367533638488115/cMzavcaYpEdvA0Q88WJRkKsaHQzAt7m-YHA6Er17l9ZRnWj0EUrdx7gCjWC9pSMehjY_'
    local embeds = {
                {
            ["title"] = message,
            ["type"] = "rich",
...
function delcarwebhook(hook,message,color)
    local delcarwebhook = 'https://discord.com/api/webhooks/878367533638488115/cMzavcaYpEdvA0Q88WJRkKsaHQzAt7m-YHA6Er17l9ZRnWj0EUrdx7gCjWC9pSMehjY_'
    local embeds = {
                {
            ["title"] = message,
            ["type"] = "rich",
...
AddEventHandler('garages:savecarlog', function() 
	...
	savecarwebhook('FoxRP.pl', wiadomosc, 11750815)
end)

function savecarwebhook(hook,message,color)
    local savecarwebhook = 'https://discord.com/api/webhooks/878367533638488115/cMzavcaYpEdvA0Q88WJRkKsaHQzAt7m-YHA6Er17l9ZRnWj0EUrdx7gCjWC9pSMehjY_'
    local embeds = {
                {
            ["title"] = message,
            ["type"] = "rich",
