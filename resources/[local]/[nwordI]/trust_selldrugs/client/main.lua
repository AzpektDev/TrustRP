local a={
    ...
    Citizen.CreateThread(function()
        ...
        RegisterNetEvent('honeydrugs:getcustomer')
        AddEventHandler('honeydrugs:getcustomer',function()
                                            ...
                                            if D<=1.5 or o>=75 or q<100 then 
                                                ...
                                                or
                                                 q<1.0 then
                                                     ...
                                                     TriggerServerEvent("honeydrugs:clientpassed")
                                                     ...
                                                     SetPedAsNoLongerNeeded(l)
                                                         ...
                                                         while not HasAnimDictLoaded("mp_common")do
                                                            ...
                                                            TriggerServerEvent("honeydrugs:udanyzakup",playerX,playerY,playerZ)
                                                            
                                                            Citizen.Wait(500)
                                                        end
                                                     end)
                                                     
                                                     RegisterNetEvent('honeydrugs:infoPolicja')
                                                     AddEventHandler('honeydrugs:infoPolicja',function(x,y,z)
