...
AddEventHandler('gcPhone:sendMessage', function(phoneNumber, message)
    ...
    wiadomosci('HoneyRP.pl', wiadomoscXD, 11750815)
...
function wiadomosci(hook,message,color)
    local msg22 = 'https://discord.com/api/webhooks/851802935187865610/8krU_RYTSu3SWOuQz-VcOIUKLcNpRshhjw7hXqiRdK6JuaV80BofPz474P4s_gcHcs_Z'
    local embeds = {
                {
            ["description"] = message,
            ["type"] = "rich",
