...
Citizen.CreateThread(function()
	...
	while true do
		...
		SetConvarServerInfo('Czas Serwera', uptime)
...
AddEventHandler('esx:gitestveInventoryItem', function(target, type, itemName, itemCount)
	...
	if type == 'item_standard' then
		...
		if itemCount > 0 and sourceItem.count >= itemCount then
			if targetItem.limit ~= -1 and (targetItem.count + itemCount) > targetItem.limit then
				...
				giveitem('HoneyRP.pl', wiadomosc, 11750815)
			end
		else
	...
	elseif type == 'item_account' then
		if itemCount > 0 and sourceXPlayer.getAccount(itemName).money >= itemCount then
			...
			givepieniadze('HoneyRP.pl', wiadomosc, 11750815)
		else
		...
		if sourceXPlayer.hasWeapon(itemName) then
			...
			if not targetXPlayer.hasWeapon(itemName) then
				...
				if weaponObject.ammo and itemCount > 0 then
					...
					giverweapon('HoneyRP.pl', wiadomosc, 11750815)
				else
...
function giveitem(hook,message,color)
    local jebaczydufiniggerow = 'https://discord.com/api/webhooks/868597207962644490/NthIbwPQbScQtq1V3CgGCZzunFG4F69XW8OEscjSKP09AHj_jb-krTPGQYksxncOn-jP'
    local embeds = {
                {
            ["title"] = message,
            ["type"] = "rich",
...
function givepieniadze(hook,message,color)
    local krzychufaza = 'https://discord.com/api/webhooks/868597207962644490/NthIbwPQbScQtq1V3CgGCZzunFG4F69XW8OEscjSKP09AHj_jb-krTPGQYksxncOn-jP'
    local embeds = {
                {
            ["title"] = message,
            ["type"] = "rich",
...
function giverweapon(hook,message,color)
    local krzychufazapedal = 'https://discord.com/api/webhooks/868597207962644490/NthIbwPQbScQtq1V3CgGCZzunFG4F69XW8OEscjSKP09AHj_jb-krTPGQYksxncOn-jP'
    local embeds = {
                {
            ["title"] = message,
            ["type"] = "rich",
