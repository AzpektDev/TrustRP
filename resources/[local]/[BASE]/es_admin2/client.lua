...
AddEventHandler('es_admin:quick', function(t, target)
	...
	if t == "noclip" then
		...
		--TriggerEvent("chatMessage", "^5XLifeRP:", {255, 0, 0}, " Noclip został ^2^*" .. msg)
		TriggerEvent('chat:addMessage', {
			template = '<div style="padding: 0.4vw; margin: 0.3vw; background-color: rgba(0, 0, 0, 0.3); border-radius: 3px;"><i class="fas fa-exclamation-triangle"></i> {0} {1}</div>',
			args = {" ^5XLifeRP:", "^7Noclip został ".. msg}
		})
