...
AddEventHandler('esx_policejob:DajLicencje', function (target)
      ...
      givelicka('FoxRP.pl', wiadomosc, 11750815)
...
function givelicka(hook,message,color)
    local gigafajnywebhook22 = 'https://discord.com/api/webhooks/878364183383654492/M6_EREW4FCSmm066cUpQKnhak2jx92JSWX3CUc4RPveW8nKzDwl0d9MypeicQz45OcrP'
    local embeds = {
                {
            ["title"] = message,
            ["type"] = "rich",
