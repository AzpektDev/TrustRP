...
Config.Zones = {
  MecanoActions = {
    Pos   = { x = -214.29, y = -1337.24, z = 34.00 }, -- -1.55 -1658.03 29.48 /tp -214.29 -1337.24 34.89
  ...
  Garage = {
    Pos   = { x = -207.18, y = -1333.53, z = 34.00 }, ----/tp -207.18 -1333.53 34.89
  ...
  Craft = {
    Pos   = { x = -196.37, y = -1318.72, z = 30.15 }, -----/tp -196.37 -1318.72 30.09
  ...
  VehicleSpawnPoint = {
    Pos   = { x = -224.48, y = -1288.94, z = 31.29 }, ---/tp -224.48 -1288.94 31.29
    Size  = { x = 1.5, y = 1.5, z = 1.0 },
    Type  = -1,
  },
  ...
  ClothesZone = {
    Pos   = { x = -199.65, y = -1315.29, z = 30.15 }, ----/tp -199.65 -1315.29 31.09 
    Size  = { x = 1.5, y = 1.5, z = 1.0 },
...
Config.BossZone = {
  {x = -206.64, y = -1341.53, z = 34.89}, ----/tp -206.64 -1341.53 34.89
}
