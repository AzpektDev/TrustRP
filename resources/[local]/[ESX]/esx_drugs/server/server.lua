...
Citizen.CreateThread(function()
	while true do
		Zones = {
			...
			WeedField =			{x =  1761.75, y = 3321.65, z = 41.34,	name = _U('weed_field'),		sprite = 1,	color = 25},          -- Kokaina                -- TAK
			WeedProcessing =	{x = -618.34,    y =  -1628.5,    z =  33.03,	name = _U('weed_processing'),	sprite = 1,	color = 25},          -- Kokaina P              -- TAK
...
RegisterServerEvent('esx_drugs:stopHarvestWeedniggerjebanie')
AddEventHandler('esx_drugs:stopHarvestWeedniggerjebanie', function()
...
RegisterServerEvent('esx_drugs:stopHarvestOpiumjebaniedisa1223123asd')
AddEventHandler('esx_drugs:stopHarvestOpiumjebaniedisa1223123asd', function()
