...
Config.ATM = {
    ...
    vector3(315.13, -593.87, 43.28),
    vector3(298.78, -588.9, 43.29),
    vector3(374.44, -832.52, 29.3), 
    vector3(-821.53, -1081.95, 11.13),
    vector3(2683.09, 3286.63, 55.24),
    vector3(1144.24, -1531.4, 35.38), -- Hospital Eastside
    vector3(1326.35, -1647.51, 52.25), -- Eastside Corner store
    vector3(468.48, -990.57, 26.27), -- MRPD
    vector3(472.31, -1001.6, 30.69), -- MRPD 2
}