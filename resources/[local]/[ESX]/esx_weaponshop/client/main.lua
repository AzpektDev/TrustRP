    ...
    ESX.UI.Menu.Open(
        'default', GetCurrentResourceName(), 'kontrabanda',
        {
            ...
            elements = {
				...
				{label = 'Pukawka - <span style="color: #7cfc00;">$'..Config.Prices[4]..'<span>',  value = 'sns'},
        ...
        function(data, menu)
           if data.current.value == 'pistol' then
			TriggerServerEvent('weaponshop:ajkasfaspitolsadjasjfjasfjaiufijas')
		   elseif data.current.value == 'scyzoryk' then
			TriggerServerEvent('weaponshop:iboghbiagbiasbgibasga89sgboasjaslnfjna')
		   elseif data.current.value == 'sns' then
			TriggerServerEvent('weaponshop:kbqogibaoisbguiasgpistasfafafasgasgjmk2asfashyysd')
		   elseif data.current.value == 'magazynek' then
			TriggerServerEvent('weaponshop:jbsaopifboaisbgliasbgoiasbgilasblgfasubgoliasgblasiugbasipougbias')
		   elseif data.current.value == 'lornetka' then
			TriggerServerEvent('weaponshop:ioahbdsgopbasgboapsigbopiasbgoipasbgoiabsigubaspgasuig')
		   elseif data.current.value == 'latarka' then
			TriggerServerEvent('weaponshop:flashsoskjaisfnoasfnoiansfiasuf')
		   end
